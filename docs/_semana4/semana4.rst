...
* Guarda en la carpeta una copia de la `rúbrica <https://docs.google.com/spreadsheets/d/1kTDNQ0duqoR0zWeb5xaCXTcCceiCqxFTEDg3L65KLZc/edit?usp=sharing>`__
...
* Comprime la carpeta principal en formato .ZIP, ojo, solo .ZIP no uses otros
  formatos por favor.
* Entrega el archivo .ZIP `aquí <https://auladigital.upb.edu.co/mod/assign/view.php?id=616105>`__.
...
* Descripción: encuentro sincrónico para compartir y discutir los
  resultados del reto de la unidad 2 e introducir la unidad 3
